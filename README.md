...
* [Darknet Tensorflow](https://github.com/thtrieu/darktf) - Tensorflow implementation of Darknet framework. With a running code for 'YOLO: Real-Time Object Detection', include training and actual support for real-time running on mobile devices.
