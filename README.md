...
* [TensorFlow Tutorial 3](http://adventuresinmachinelearning.com/python-tensorflow-tutorial/) - A gentle introduction to TensorFlow for beginnners, starting with a simple computational graph and ending in an MNIST predicting neural network
